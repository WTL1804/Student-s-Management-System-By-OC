...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *nav2 = [[UINavigationController alloc] initWithRootViewController:[[zhuceViewController alloc]init]];
    ...
    NSArray *array = [NSArray arrayWithObjects:nav, nav2, nav3, nil];
